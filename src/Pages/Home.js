            ...
            <div className="trending container-fluid p-0">
                    ...
                    {trending.map((e, i)=>(
                        <div key={i} id={e.id} className="card col-lg-2 col-xs-5 mt-lg-10">
                           ...
                           <div className="btn rounded-pill bg-white bg-opacity-50 cardText1" style={{position: "absolute",top: "15px",left: "15px", color: "white"}}>{e.airline} Airline</div>
                            ...
                            <div className="btn rounded-circle bg-white bg-opacity-25 btnback" style={{position: "absolute",bottom: "15px",right: "25px", color: "white"}}><img src="https://github.com/aliefabdussalam/learn-html1/blob/master/btnback.png?raw=true"/></div>
                        </div>
                    ))}
                </div>
                <div className="container-fluid topDestination col-10 offset-1">
                        ...
                        <div className="d-flex row destbtn">
                            <div className="btn rounded col-1 border-white"><img src="https://github.com/aliefabdussalam/learn-html1/blob/master/btnback%20(2).png?raw=true"/></div>
                            <div className="btn-light rounded col-1 offset-1 "><img style={{marginTop:"8px", marginLeft:"8px"}} src="https://github.com/aliefabdussalam/learn-html1/blob/master/btnback%20(1).png?raw=true"/></div>
                        </div>
                </div>
            </div>
        </div>
